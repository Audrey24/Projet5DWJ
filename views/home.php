      ...
      <div class="product-item-title d-flex">
        <div class="bg-faded p-5 d-flex mr-auto rounded">
          <h2 class="section-heading mb-0">
            <span class="section-heading-upper">Créer un évènement</span>
            <span class="section-heading-lower">Inviter vos proches</span>
            </h2>
          </div>
        </div>
    ...
    <div class="product-item">
      <div class="product-item-title d-flex">
        <div class="bg-faded p-5 d-flex ml-auto rounded">
          <h2 class="section-heading mb-0">
            <span class="section-heading-upper">Partager vos souvenirs</span>
            <span class="section-heading-lower">Photos &amp; vidéos</span>
          </h2>
        </div>
      </div>
  ...
  <div class="container">
    <div class="product-item">
      <div class="product-item-title d-flex">
        <div class="bg-faded p-5 d-flex mr-auto rounded">
          <h2 class="section-heading mb-0">
            <span class="section-heading-upper">Une anecdocte à partager ?</span>
            <span class="section-heading-lower">Laisser un message</span>
          </h2>
        </div>
      </div>
